                ...
                <div className="pt-2 flex flex-col gap-3 text-[10px] uppercase tracking-widest text-[#9A9A9A]">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 pt-1">
                    ...
                    <div className="flex items-start gap-2.5 flex-1 border border-gray-100 bg-white px-4 py-3">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5} className="flex-shrink-0 mt-0.5 text-[#C4A96B]">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 18.75a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h6m-9 0H3.375a1.125 1.125 0 01-1.125-1.125V14.25m17.25 4.5a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m3 0h1.125c.621 0 1.129-.504 1.09-1.124a17.902 17.902 0 00-3.213-9.193 2.056 2.056 0 00-1.58-.86H14.25M16.5 18.75h-2.25m0-11.177v-.958c0-.568-.422-1.048-.987-1.106a48.554 48.554 0 00-10.026 0 1.106 1.106 0 00-.987 1.106v7.635m12-6.677v6.677m0 4.5v-4.5m0 0h-12" />
                      </svg>
                      <div>
                        <p className="text-[#1A1A1A] font-normal">Free Shipping</p>
                        <p className="text-[#9A9A9A] normal-case text-[10px] mt-0.5">On orders above ₹999</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-2.5 flex-1 border border-gray-100 bg-white px-4 py-3">
                      ...
                      <div>
                        <p className="text-[#1A1A1A] font-normal">Easy Returns</p>
                        <p className="text-[#9A9A9A] normal-case text-[10px] mt-0.5">7-day hassle-free returns</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-2.5 flex-1 border border-gray-100 bg-white px-4 py-3">
                      ...
                      <div>
                        <p className="text-[#1A1A1A] font-normal">100% Authentic</p>
                        <p className="text-[#9A9A9A] normal-case text-[10px] mt-0.5">Verified & quality checked</p>
                      </div>
                    </div>
                  </div>
                </div>
