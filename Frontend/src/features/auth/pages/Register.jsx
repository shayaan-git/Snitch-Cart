...
const Register = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#FAF8F5] flex flex-col lg:flex-row">
      ...
      {/* Left Side — Image Panel: sticky so it stays in view while right side scrolls */}
      <div className="hidden lg:block lg:w-1/2 relative bg-[#1A1A1A] overflow-hidden sticky top-0 h-screen flex-shrink-0">
        ...
        <div className="absolute bottom-14 left-14 max-w-md pointer-events-none">
          ...
          <p className="text-white/60 text-sm uppercase tracking-widest">
            Join the ultimate premium marketplace
          </p>
        </div>
      </div>

      {/* Right Side — scrolls internally if content overflows on very small screens */}
      <div className="flex-1 lg:w-1/2 flex items-center justify-center px-8 py-6 lg:px-16 xl:px-24 overflow-y-auto">
        {/* Form Container */}
        <div className="w-full max-w-sm">
          ...
          >
            ...
            <label
              htmlFor="isSeller"
              className="flex items-center gap-3 cursor-pointer group mt-0.5"
            >
              <div className="relative flex-shrink-0">
                ...
                <div
                  className="
                    ...
                    bg-transparent
                    peer-checked:bg-[#C4A96B] peer-checked:border-[#C4A96B]
                    transition-all duration-200
                    group-hover:border-[#C4A96B]/60
              ...
              <span className="text-xs text-gray-500 uppercase tracking-widest group-hover:text-[#1A1A1A] transition-colors duration-200 select-none">
